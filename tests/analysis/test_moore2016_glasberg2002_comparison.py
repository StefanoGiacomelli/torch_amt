...
def compare_diotic_tone():
    ...
    # Glasberg2002
    glasberg = Glasberg2002(fs=32000, return_stages=True)
    lLoud_g, stages_g = glasberg(audio_mono)
    sLoud_g = stages_g['stl']
...
def compare_dichotic():
    ...
    glasberg = Glasberg2002(fs=32000, return_stages=True)
    lLoud_g, stages_g = glasberg(audio_left.unsqueeze(0))
    sLoud_g = stages_g['stl']
